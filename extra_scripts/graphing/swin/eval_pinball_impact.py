...
Usage:
    python eval_pinball_impact.py --checkpoint /home/peytonli/26.6_wind/runs/0729_meangate/checkpoints/best.pth
...
def main() -> None:
    ...
    output = args.output or (Path(paths["log_dir"]) / "figures" / "pinball_impact.png")
