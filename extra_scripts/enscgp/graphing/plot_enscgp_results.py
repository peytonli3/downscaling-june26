...
data_prep/build_hires_land_mask.py), not the 0.25-deg ERA5 LSM raster used as a model feature in
...
from paths import DATA_DIR, run_figures  # noqa: E402
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help="Land mask built by data_prep/build_hires_land_mask.py: keys 'wrf' (200,200), 'era34' (34,34)",
    )
    ...
    parser.add_argument("--output", type=Path, default=run_figures("0701") / "enscgp_panels.png", help="Output PNG path")
    ...
    # wrf: row 0 = south -- see data_prep/build_hires_land_mask.py, which reads the same raw
