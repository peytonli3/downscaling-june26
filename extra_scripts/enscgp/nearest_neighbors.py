...
sys.path.insert(0, str(Path(__file__).resolve().parent.parent / "extra_scripts"))
from split_temporal_dataset import load_event_metadata  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
	...
	p.add_argument("--mat_path", type=str, default="/net/momo/data/projects/downscaling/datasource/wndata.mat")
	p.add_argument("--era_npy", type=str, default="/home/peytonli/26.6_wind/data/era5_uv_2ch.npy", help="ERA5 npy option")
	p.add_argument("--k", type=int, default=10)
	p.add_argument("--output", type=str, default="data/neighbors.npy")
	...
	p.add_argument(
		"--event_ids_csv",
		type=str,
		default="data/sample_event_ids.csv",
