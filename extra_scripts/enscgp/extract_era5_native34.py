...
Example:
    python extract_era5_native34.py \
        ...
        --output /home/peytonli/26.6_wind/data/era5_uv_2ch_native34.npy
"""
...
def main():
    ...
    parser.add_argument("--output", type=str, default="/home/peytonli/26.6_wind/data/era5_uv_2ch_native34.npy")
