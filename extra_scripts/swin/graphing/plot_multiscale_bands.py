...
2..n_levels+1) Each Laplacian band's magnitude sqrt(band_u^2 + band_v^2), ordered
   ...
   extra_scripts/swin/oneoff/band_error_diagnostics.py's plots), labeled with its approximate physical
   ...
   extra_scripts/swin/compare_eigenspectra.py).
...
def main() -> None:
    ...
    parser.add_argument("--output", type=Path,
                         default=run_figures("0629") / "multiscale_bands_panels.png",
