...
Usage:
    python plot_training_curves.py --logs runs/0714/train_20260714_235959.log
    python plot_training_curves.py --log_dir runs/0714
...
def main() -> None:
    ...
    log_dir = args.log_dir or resolve_path(config["paths"]["log_dir"])
