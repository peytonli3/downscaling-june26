...
Output: runs/0714/presentation/q10_q50_q90_model.pptx -- this script lives under
extra_scripts/ (it is source), but its .pptx is a run artifact and belongs with the run.
Speaker notes (with rough timing) are attached to every slide."""
import sys
...
RUN = RUNS_DIR / "0714"
FIG = RUN / "figures"
OUT = RUN / "presentation" / "q10_q50_q90_model.pptx"
