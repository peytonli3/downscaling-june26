...
Python -- run this with the project conda env (see CLAUDE.md), e.g.
    python build_hires_features.py
"""
...
from paths import COPERNICUS_DEM_TIF, DATA_DIR, WNDATA_MAT  # noqa: E402
...
def main() -> None:
    ...
    parser.add_argument("--dem_tif_path", type=str, default=str(COPERNICUS_DEM_TIF))
