...
Example (paths default to data/, see scripts/paths.py):
...
from paths import DATA_DIR, WNDATA_MAT as DEFAULT_MAT_PATH  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--output_dir",
        type=Path,
        default=DATA_DIR / "splits_70_15_15",
    ...
    era_path = args.era_npy or find_default_path([DATA_DIR / "era5_uv_2ch.npy"])
    wrf_path = args.wrf_npy or find_default_path([DATA_DIR / "wrf_uv.npy"])
